...
letter1.addEventListener('keyup', (e) => {
    if (letter1.value === "D" || letter1.value === "d") {
...
letter2.addEventListener('keyup', (e) => {
    if (letter2.value === "E" || letter2.value === "e") {
...
letter3.addEventListener('keyup', (e) => {
    if (letter3.value === "S" || letter3.value === "s") {
...
letter4.addEventListener('keyup', (e) => {
    if (letter4.value === "S" || letter4.value === "s") {
...
letter5.addEventListener('keyup', (e) => {
    if (letter5.value === "E" || letter5.value === "e") {
...
letter6.addEventListener('keyup', (e) => {
    if (letter6.value === "R" || letter6.value === "r") {
...
letter7.addEventListener('keyup', (e) => {
    if (letter7.value === "T" || letter7.value === "t") {
        createConfetti()
...
misslet1.addEventListener('keyup', (e) => {
    if (misslet1.value === "D" || misslet1.value === "d") {
        createConfetti()
